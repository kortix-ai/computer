  ...
  return (
    <nav className="flex items-center gap-1 text-sm min-w-0 overflow-x-auto">
      ...
      <button
        ...
        className={cn(
          'flex items-center gap-1.5 px-2 py-1 rounded-xl transition-colors cursor-pointer shrink-0',
          'hover:bg-muted',
          segments.length === 0
        ...
        return (
          <div key={pathToHere} className="flex items-center gap-1 min-w-0">
            ...
            <button
              ...
              className={cn(
                'px-1.5 py-1 rounded-xl transition-colors cursor-pointer truncate max-w-[150px]',
                'hover:bg-muted',
                isLast
                  ? 'text-foreground font-medium'
                  : 'text-muted-foreground',
