...
const BIOS_LINES: { id: string; text: string; bold?: boolean }[] = [
  { id: 'bios-version', text: 'KORTIX BIOS v2.0.1', bold: true },
  { id: 'spacer-top', text: '' },
  { id: 'cpu', text: 'CPU: Kortix Inference Engine X1 @ 3.80 GHz' },
  { id: 'memory-test', text: 'Memory test................. OK' },
  { id: 'neural-cores', text: 'Neural cores............... 8/8 online' },
  { id: 'agent-runtime', text: 'Agent runtime.............. initialized' },
  { id: 'tool-registry', text: 'Tool registry.............. 47 tools loaded' },
  { id: 'secure-enclave', text: 'Secure enclave............. active' },
  { id: 'mounting-workspace', text: 'Mounting workspace......... done' },
  { id: 'connecting-services', text: 'Connecting to services..... done' },
  { id: 'spacer-bottom', text: '' },
  { id: 'all-systems-nominal', text: 'All systems nominal. Starting KORTIX OS...' },
];
...
function LoadingDots() {
  const dots = ['loading-dot-1', 'loading-dot-2', 'loading-dot-3'];
...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    ...
    if (params.has('skip_onboarding')) {
      ...
      authenticatedFetch(`${instanceUrl}/env/ONBOARDING_COMPLETE`, {
        ...
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ value: 'true' }),
      }).catch(() => {}).finally(() => setRedirectTarget('/dashboard'));
      return;
    }
  ...
  useEffect(() => {
    ...
    const verifyAndRedirect = async () => {
      ...
      setRedirectTarget('/auth?redirect=%2Fonboarding');
    };
  ...
  }, [phase, sessionError, retryTick, isHetznerOnboarding, waitForSandboxHealthVersion, sandbox?.external_id, isSandboxAuthError, refreshSandboxRouting]);
          ...
          {phase === 'bios' && (
            ...
            >
              <div className="font-mono text-[13px] sm:text-sm leading-relaxed">
                 {BIOS_LINES.slice(0, visibleLines).map((line) => (
                  <m.div
                    key={line.id}
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
