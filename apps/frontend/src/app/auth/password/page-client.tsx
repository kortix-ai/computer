...
type PasswordAuthPageProps = {
  returnUrl?: string;
};

function PasswordAuthContent({ returnUrl }: PasswordAuthPageProps) {
...
export default function PasswordAuth(props: PasswordAuthPageProps) {
  return (
    <Suspense
      fallback={
        <main className="flex flex-col items-center justify-center min-h-screen w-full">
