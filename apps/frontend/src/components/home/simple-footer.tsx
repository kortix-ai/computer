    ...
    <footer className="w-full border-t border-border/50">
      <div className="px-5 py-10 md:py-14">
          ...
          <div className="flex flex-col gap-5 md:w-56">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <a
                ...
                aria-label="GitHub"
                className="flex items-center gap-1.5 h-8 px-2.5 rounded-lg bg-muted/50 hover:bg-muted transition-colors text-muted-foreground hover:text-foreground"
              >
                ...
                <span className={`text-xs font-medium tabular-nums ${starsLoading ? 'opacity-40' : ''}`}>
                  {formattedStars}
                </span>
              </a>
              ...
              <a href="https://discord.com/invite/RvFhXUdZ9H" target="_blank" rel="noopener noreferrer" aria-label="Discord"
                className="flex items-center justify-center size-8 rounded-lg bg-muted/50 hover:bg-muted transition-colors text-muted-foreground hover:text-foreground">
                <svg viewBox="0 0 24 24" className="size-3.5" fill="currentColor">
        ...
        <div className="mt-10 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-muted-foreground/50">
            Built with love across America, Europe & Asia
          </p>
        </div>
      </div>
    </footer>
