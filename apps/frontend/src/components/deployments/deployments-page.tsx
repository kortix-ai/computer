...
const LoadingSkeleton = () => (
  <div className="space-y-4">
    {['deployment-skeleton-1', 'deployment-skeleton-2', 'deployment-skeleton-3'].map((skeletonKey) => (
      <div key={skeletonKey} className="rounded-xl border dark:bg-card px-5 py-4">
