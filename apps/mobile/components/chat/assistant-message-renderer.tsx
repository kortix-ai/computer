...
import type { UnifiedMessage, ParsedMetadata, ParsedContent } from '@kortix/shared';
import { safeJsonParse, getUserFriendlyToolName, isAskOrCompleteTool, extractTextFromArguments } from '@kortix/shared';
...
import { parseXmlToolCalls, preprocessTextOnlyTools, isHiddenTool } from '@kortix/shared/tools';
import { normalizeArrayValue, normalizeAttachments } from '@kortix/shared/utils';
...
// normalizeArrayValue and normalizeAttachments are now imported from @kortix/shared/utils
