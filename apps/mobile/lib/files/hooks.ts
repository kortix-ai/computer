...
import type { SandboxState, SandboxStatus } from '@kortix/shared/types/sandbox';
import { normalizeFilenameToNFC } from './utils';

// Re-export sandbox types for convenience
export type { SandboxState, SandboxStatus } from '@kortix/shared/types/sandbox';
export {
  deriveSandboxStatus,
  isSandboxUsable,
...
} from '@kortix/shared/types/sandbox';
